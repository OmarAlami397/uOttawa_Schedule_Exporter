class Exam {
  ...
  // Getters
  get courseCode() { return this._course_code; }
  get description() { return this._description; }
  get examType() { return this._exam_type; }
  get examDate() { return this._exam_date; }
  get schedule() { return this._schedule; }
  get room() { return this._room; }

  //Setters
  set courseCode(value) { this._course_code = value; }
  set description(value) { this._description = value; }
  set examType(value) { this._exam_type = value; }
  set examDate(value) { this._exam_date = value; }
  set schedule(value) { this._schedule = value; }
  set room(value) { this._room = value; }

  toString() {
    return `${this._course_code} — ${this._description}\n` +
